// PTS learning-moment workshop. This client deliberately shadows only the
// `landscape` conversation.view at a lower slot priority. Product/status and
// the host/domain routes stay with pts-landscape.
