...
- **Karte anklicken** markiert sie als aktiv (deutlicher grüner Rahmen). Die
  ...
  (ein historischer Import hatte in `hoffnung` alle vier Klärungen mit derselben
  ID abgelegt). Nur die tatsächlich angeklickte Karte wird
  markiert.
