...
of workspace documentation (`services/DOCUMENTARIAN.md`): complete draft
moments may be recorded by the Documentarian only after an explicit bounded
documentation check and with their provisional status preserved.
