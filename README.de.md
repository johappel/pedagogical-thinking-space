...
Die nativen Worker `pts_research`, `pts_edit`, `pts_document`,
`pts_documentarian`, `pts_material`, `pts_review` und `pts_renderer` werden im
DSH-Preset konfiguriert. Der Documentarian prüft Workspace-Vollständigkeit und
Provenienz, ist aber weder Dispatcher noch pädagogische Entscheidungsinstanz.
